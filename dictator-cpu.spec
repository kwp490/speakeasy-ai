...
"""
PyInstaller spec for dictat0r.AI — CPU-only variant (no CUDA/GPU).

Build: pyinstaller dictator-cpu.spec
Output: dist/dictator-cpu/dictator.exe (onedir)
...
_variant_path = _os.path.join('dictator', '_build_variant.py')
